...
public class PenjualanMotor extends javax.swing.JFrame {
    int bebek, sport, diskon, total, harga, totaldiskon;
    
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(PenjualanMotor.class.getName());
    private int matik;
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(189, 224, 241));
        ...
        cbo_merk.addActionListener(this::cbo_merkActionPerformed);

        buttonGroup1.add(rd_bebek);
        rd_bebek.setText("BEBEK");
        rd_bebek.addActionListener(this::rd_bebekActionPerformed);

        buttonGroup1.add(rd_sport);
        rd_sport.setText("SPORT");
        rd_sport.addActionListener(this::rd_sportActionPerformed);

        buttonGroup1.add(rd_matik);
        rd_matik.setText("MATIK");
        rd_matik.addActionListener(this::rd_matikActionPerformed);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(cbo_merk, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel2.setBackground(new java.awt.Color(189, 224, 241));
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txt_total, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))))
        ...
        cbo_pembayaran.addActionListener(this::cbo_pembayaranActionPerformed);

        btn_hitung.setBackground(new java.awt.Color(51, 76, 153));
        btn_hitung.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btn_hitung.setForeground(new java.awt.Color(255, 255, 255));
        btn_hitung.setText("HITUNG");
        btn_hitung.addActionListener(this::btn_hitungActionPerformed);

        btn_hitunglagi.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btn_hitunglagi.setText("HITUNG LAGI");
        btn_hitunglagi.addActionListener(this::btn_hitunglagiActionPerformed);

        btn_selesai.setBackground(new java.awt.Color(250, 75, 75));
        btn_selesai.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        btn_selesai.setText("X SELESAI");
        btn_selesai.addActionListener(this::btn_selesaiActionPerformed);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(cbo_pembayaran, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel7)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(cbo_pembayaran, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(btn_hitung)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jPanel2, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    if (cbo_pembayaran.getSelectedItem().equals("TUNAI")) {
        diskon = 20;
    } else if (cbo_pembayaran.getSelectedItem().equals("KREDIT")) {
        diskon = 8;
    }
}
...
if (konfirmasi == JOptionPane.YES_OPTION) {
    ...
    e.printStackTrace();
        ...
        java.awt.EventQueue.invokeLater(() -> new PenjualanMotor().setVisible(true));
    }
